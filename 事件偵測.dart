  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: Scaffold(
        appBar: AppBar(
          title:
              const Text('Click anywhere and check the logs!', style: TextStyle(color: darkBlue)),
                        ...
                        children: <Widget>[
                          Row(
                            ...
                            children: <Widget>[
                              ...
                              Checkbox(
                                onChanged: (bool? newVal) => setState(() => _singleTaps = newVal ?? false),
                                value: _singleTaps,
                              ),
                            ],
                          ),
                          Row(
                            ...
                            children: <Widget>[
                              ...
                              Checkbox(
                                onChanged: (bool? newVal) => setState(() => _doubleTaps = newVal ?? false),
                                value: _doubleTaps,
                              ),
                            ],
                          ),
                          Row(
                            ...
                            children: <Widget>[
                              ...
                              Checkbox(
                                onChanged: (bool? newVal) => setState(() => _longPresses = newVal ?? false),
                                value: _longPresses,
                              ),
                            ],
                          ),
                          Row(
                            ...
                            children: <Widget>[
                              ...
                              Checkbox(
                                onChanged: (bool? newVal) => setState(() => _pans = newVal ?? false),
                                value: _pans,
                              ),
                            ],
                          ),
